...
export default function LoginPage() {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen ">
      <form onSubmit={handleLogin} className="p-8 bg-white rounded-lg shadow-xl flex flex-col w-full max-w-md">
        <h2 className="text-center">Admin Dashboard Login</h2>
        ...
        <div className="mb-4 flex flex-col">
          ...
          <input
            ...
            required
            className="p-3 border border-gray-300 rounded text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
        ...
        <div className="mb-4 flex flex-col">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full p-3 border border-gray-300 rounded text-base text-gray-800 focus:outline-none focus:ring-2 focus:ring-blue-500 pr-10" // เพิ่ม padding ขวา
            />
            {/* (11) ปุ่ม Toggle */}
            <button
              type="button"
